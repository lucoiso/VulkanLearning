...
void CreatePipeline(bool const IsViewport,
                    VkFormat const RenderingFormat,
                    ...
                    VkPipeline& OutPipeline)
{
    ...
    VkPipelineColorBlendStateCreateInfo const ColorBlendState {
            ...
            .attachmentCount = 1U,
            .pAttachments    = IsViewport ? &ViewportColorBlendAttachmentStates : &RenderColorBlendAttachmentStates,
            .blendConstants  = {
                    0.F,
                    0.F,
                    0.F,
    ...
    VkPipelineCreationFeedback PipelineCreationFeedback {
            .flags    = VK_PIPELINE_CREATION_FEEDBACK_VALID_BIT | VK_PIPELINE_CREATION_FEEDBACK_APPLICATION_PIPELINE_CACHE_HIT_BIT | VK_PIPELINE_CREATION_FEEDBACK_BASE_PIPELINE_ACCELERATION_BIT,
            .duration = 0U};
...
void PipelineManager::CreatePipelines(VkFormat const SwapChainImageFormat,
                                      VkFormat const DepthFormat,
                                      VkExtent2D const& ViewportExtent)
{
    ...
    CheckVulkanResult(vkCreatePipelineLayout(volkGetLoadedDevice(),
    ...
    CheckVulkanResult(vkCreatePipelineCache(volkGetLoadedDevice(),
...
void PipelineManager::CreateDescriptorSetLayout()
{
    ...
    CheckVulkanResult(vkCreateDescriptorSetLayout(volkGetLoadedDevice(),
...
void PipelineManager::CreateDescriptorPool(std::uint32_t const NumAllocations)
{
    ...
    CheckVulkanResult(vkCreateDescriptorPool(volkGetLoadedDevice(),
                                           ...
                                           VkSampler const& Sampler)
{
    ...
    for (auto Iterator = std::begin(AllocatedObjects); Iterator != std::end(AllocatedObjects); ++Iterator)
    {
        ...
        {
            vkUpdateDescriptorSets(volkGetLoadedDevice(),
