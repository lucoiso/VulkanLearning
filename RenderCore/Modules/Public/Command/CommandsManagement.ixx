...
namespace RenderCore
{
    ...
    export void RecordCommandBuffers(std::uint32_t, std::uint32_t, Camera const&, BufferManager const&, PipelineManager const&, std::vector<std::shared_ptr<Object>> const&);
